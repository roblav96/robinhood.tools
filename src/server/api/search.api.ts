...
const IKEYS = ['name', 'type', 'acronym', 'country', 'marketCap'] as KeysOf<Quotes.Quote> // ['symbol', 'name', 'tinyName', 'country', 'exchange', 'acronym', 'mic', 'type', 'typeof'] as KeysOf<Quotes.Quote>

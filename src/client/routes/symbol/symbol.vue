					...
					<div class="columns tablet-only:flex-wrap">
							...
							<div class="columns is-mobile">
								...
								<div class="column is-narrow">
									<p class="title is-size-3">
										...
										<span class="subtitle font-medium"> x {{vnumber(wbquote.volume,{compact:true})}}</span>
									</p>
									<p class="subtitle is-size-5 whitespace-no-wrap font-semibold" v-ui-green-red="wbquote.change">
						...
						<div class="column is-4-tablet is-2-desktop">
							...
							<div class="columns is-mobile is-gapless mb-0">
								...
								<p class="column is-size-7 has-text-centered">Price</p>
							...
							<div class="columns is-mobile is-gapless mb-0">
								...
								<p class="column is-size-7 has-text-centered">Size</p>

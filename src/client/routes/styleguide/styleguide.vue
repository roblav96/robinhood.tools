...
<template>
	<section>
		<section class="section">
			<div class="container">
				<div class="box buttons is-block has-text-centered">
					...
					<button class="button is-large is-white has-background-white-bis">
						white-bis
					</button>
					<button class="button is-large is-white has-background-white-ter">
						white-ter
					</button>
					<hr class="mb-2" />
					<button class="button is-large is-white has-background-grey-lightest">
						grey-lightest
					</button>
					<button class="button is-large is-white has-background-grey-lighter">
						grey-lighter
					</button>
					<button class="button is-large is-white has-background-grey-light">
						grey-light
					</button>
					<button class="button is-large is-black has-background-grey">grey</button>
					<hr class="mb-2" />
					<button class="button is-large is-black has-background-grey-dark">
						grey-dark
					</button>
					<button class="button is-large is-black has-background-grey-darker">
						grey-darker
					</button>
					<hr class="mb-2" />
					<button class="button is-large is-black has-background-black-ter">
						black-ter
					</button>
					<button class="button is-large is-black has-background-black-bis">
						black-bis
					</button>
		...
		<section class="section">
			<div class="container">
				<div class="box buttons is-block has-text-centered has-background-dark">
					...
					<button class="button is-large is-inverted is-dark">dark</button>
				</div>
			</div>
		</section>
	</section>
